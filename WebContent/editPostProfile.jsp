...
<div id="top-bar" class="container">
	...
	try{
		...
		%>
			<form action = "entry/post/updatePost" method = "POST">
			<input type="hidden" name="productname" value = "<%=productname %>"/>
			<h3>Price : <input type="text" name="price" value = "<%=price%>" required/></h3><br/>
			<h3>Contact Number : <input type="text" name="contactnumber" value = "<%=contactnumber%>" required/></h3><br/>
