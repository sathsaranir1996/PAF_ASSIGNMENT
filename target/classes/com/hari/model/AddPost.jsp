...
<div id="top-bar" class="container">
		...
		<div id="wrapper" class="container">
			...
			<section class="main-content">
				<!-- Main Content -->
				<form style = "text-align: center" action="entry/post/Register" method="POST">
					<h1>Add Post</h1>
					<label>Products Picture:</label><input type="file" name="profilepic"  required>
					<label>Product Name:</label> <input type="text" name="productname" required/><br/>
					<label>Price (Rs):</label> <input type="text" name="price" required/><br/>
					...
					<label>Description:</label> <input type="text" name="dec" required/><br/>
					<br/>
				<br/>
